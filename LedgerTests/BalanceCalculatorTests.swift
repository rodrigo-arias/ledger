...
final class BalanceCalculatorTests: XCTestCase {
    ...
    func testCalculate_equalIncome_splitsFairly() throws {
        ...
        let config2 = MonthlyConfig(year: 2_025, month: 12, exchangeRate: 1_000, incomeUSD: 1_000, fixedExpensesDebtorId: nil)
    ...
    func testCalculate_unequalIncome_weightedSplit() throws {
        ...
        let config1 = MonthlyConfig(year: 2_025, month: 12, exchangeRate: 1_000, incomeUSD: 3_000, fixedExpensesDebtorId: nil)
        config1.person = person1
        let config2 = MonthlyConfig(year: 2_025, month: 12, exchangeRate: 1_000, incomeUSD: 1_000, fixedExpensesDebtorId: nil)
        config2.person = person2
